...
namespace AsbtCore.MajordomoProtocol
{
    /// <summary>
    ...
    internal class Service
    {
        ...
        /// </summary>
        public List<NetMQMessage> PendingRequests { get; }
        ...
        public Service(string name)
        {
            ...
            PendingRequests = new List<NetMQMessage>();
        ...
        {
            return m_waitingWorkers.Count > 0 && PendingRequests.Count > 0;
        }
        ...
        {
            // get one or null
            var request = PendingRequests.Count > 0 ? PendingRequests[0] : null;
        ...
        {
            return $"Name = {Name} / Worker {m_workers.Count} - Waiting {m_waitingWorkers.Count} - Pending REQ {PendingRequests.Count}";
        }
