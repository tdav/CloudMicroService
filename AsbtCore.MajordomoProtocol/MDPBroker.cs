...
namespace AsbtCore.MajordomoProtocol
{
    ...
    public class MDPBroker : IMDPBroker
    {
        ...
        private MDPBroker()
        {
            ...
            HeartbeatInterval = TimeSpan.FromMilliseconds(2500); // otherwise the expiry would be 0(!)
        ...
        public MDPBroker([NotNull] string endpoint, int heartbeatInterval = 0) : this()
        {
        ...
        private void ProcessReceivedMessage(object sender, NetMQSocketEventArgs e)
        {
            ...
            _ = msg.Pop();                     // [protocol header][service or command][data]
